...
export function getSdkWithHooks(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  ...
  return {
    ...sdk,
    useVeBalGetVotingList(variables?: VeBalGetVotingListQueryVariables, config?: SWRConfigInterface<VeBalGetVotingListQuery, ClientError>) {
      return useSWR<VeBalGetVotingListQuery, ClientError>(genKey<VeBalGetVotingListQueryVariables>('VeBalGetVotingList', variables), () => sdk.veBalGetVotingList(variables), config);
    }
  };
}
