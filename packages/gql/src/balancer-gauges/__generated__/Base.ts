...
export function getSdkWithHooks(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  ...
  return {
    ...sdk,
    useGauge(variables: GaugeQueryVariables, config?: SWRConfigInterface<GaugeQuery, ClientError>) {
      return useSWR<GaugeQuery, ClientError>(genKey<GaugeQueryVariables>('Gauge', variables), () => sdk.Gauge(variables), config);
    }
  };
}
